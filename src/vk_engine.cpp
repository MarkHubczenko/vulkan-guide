...
{
	// wait until the GPU has finished rendering the last frame. Timeout of 1 second (it uses nanoseconds)
	...
	// it will block the thread with a maximum for the timeout set, which will be 1 second. This will be our FPS lock.
